...
<section class="content">
    <div class="card shadow mb-4">
        <div class="tambahBtn">
            <a class="btn btn-primary float-right mt-3 mr-4" style="width: fit-content;padding:.5rem; height:fit-content;" href="/perdin/tambah"><i class="fas fa-plus"></i> Tambah Perdin</a>
        </div>
